...
df = pd.read_json('https://api.binance.com/api/v1/ticker/24hr')
...
#widget (cryptocurruency selection box)
...
#Dataframe of selected cryptocurruency
...
#Apply a custom function to condionally round values
...
st.info('Created by Ashish Kumar  Github-(https://github.com/Ashsky72/cryptocurrency-dashboard)') 
